...
const riverHyacinthAsset = { url: "/images/river-hyacinth.jpg" };
const riverMixedGarbageAsset = { url: "/images/river-mixed-garbage.jpg" };
const riverImpactAsset = { url: "/images/river-impact.jpg" };
const riverAwarenessAsset = { url: "/images/river-awareness.jpg" };
const lakeDriveAsset = { url: "/images/lake-cleaning-drive.jpg" };
const lakeWasteAsset = { url: "/images/lake-waste-debris.jpg" };
const lakeBalanceAsset = { url: "/images/lake-natural-balance.jpg" };
const treePlantingFutureAsset = { url: "/images/tree-planting-future.jpg" };
const treeBeyondPlantingAsset = { url: "/images/tree-beyond-planting.jpg" };
const treeGreenCommunitiesAsset = { url: "/images/tree-green-communities.jpg" };
const awarenessMovementAsset = { url: "/images/awareness-movement.jpg" };
const awarenessEducatingAsset = { url: "/images/awareness-educating.jpg" };
const awarenessCivicAsset = { url: "/images/awareness-civic.jpg" };
